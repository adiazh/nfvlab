...
neutron subnet-create --name subnet-tag1 tag1 10.13.1.0/24 --allocation_pool start=10.13.1.3,end=10.13.1.3
...
neutron subnet-create --name subnet-tag2 tag2 10.13.1.0/24 --allocation_pool start=10.13.1.3,end=10.13.1.3
...
neutron subnet-create --name subnet-tag3 tag3 10.13.1.0/24 --allocation_pool start=10.13.1.3,end=10.13.1.3
...
neutron subnet-create --name subnet-tag4 tag4 10.13.1.0/24 --allocation_pool start=10.13.1.3,end=10.13.1.3
