#export NFV_ROOT=$HOME/shared
#export JUJU=$NFV_ROOT/DevelJuju
#cd $NFV_ROOT
#source config/OSM-openrc.sh
...
neutron subnet-create --name subnet-mgmt mgmt 10.208.0.0/24 --allocation_pool start=10.208.0.3,end=10.208.0.99
...
neutron subnet-create --name subnet-tag1 tag1 10.13.1.0/24 --allocation_pool start=10.13.1.3,end=10.13.1.4
...
neutron subnet-create --name subnet-tag2 tag2 10.13.1.0/24 --allocation_pool start=10.13.1.3,end=10.13.1.4
...
neutron subnet-create --name subnet-tag3 tag3 10.13.1.0/24 --allocation_pool start=10.13.1.3,end=10.13.1.4
